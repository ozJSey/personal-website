  ...
  <section id="rate"> 
    <div class="container">
        <div class="playground">
            <img src="../assets/Github.png" alt="" class="img-fluid" srcset="">
    ...
    #rate{
        ...
        >div{
            ...
            &.animate{
                ...
                transform:perspective(100px) rotateZ(3deg) skewX(5deg) translate(-10px, 30px);
                }
            }
            &::after{
                content: '';
            ...
            .playground{
               ...
               *{
               ...
               &::after{
                   ...
                   margin-top: 50px;
                   background: linear-gradient(110deg, transparent -20%, white 25% 70% , rgba(0,0,0,0.99) 70%);

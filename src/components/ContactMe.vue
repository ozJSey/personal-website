  ...
  <section id="contactMe">
    <div class="container">
      <div class="row">
        ...
        <div
          @click="reverseSendForm"
          class="col-12 contactForm"
        >
          ...
          <input
            ...
            id="email"
            @click="copy"
            value="ozgur.seyidoglu.sw@gmail.com"
          >
          <p style="text-align:center">Thank you for visiting my website!</p>
          <a
            target="_blank"
            href="https://www.linkedin.com/in/ozgur-seyidoglu-024449168/"
          >
            <font-awesome-icon
              class="animateIcon"
              :icon="[ 'fab', 'linkedin' ]"
...
#contactMe {
  ...
  .contactForm {
    ...
    p {
      ...
      &.animate {
        animation: text 0.5s cubic-bezier(0.075, 0.82, 0.165, 1) 0s 1 normal
          forwards;
      }
    }
    h2 {
      ...
      transition: all 1s ease;
      &.animate {
        animation: text 0.5s cubic-bezier(0.075, 0.82, 0.165, 1) 1.5s 1 normal
          forwards;
      }
    }
    a {
      ...
      &.animate {
        animation: text 0.5s cubic-bezier(0.075, 0.82, 0.165, 1) 2s 1 normal
          forwards;
        svg {
          color: #fdecff;
          font-size: 35px;
    ...
    input {
      ...
      &.animate {
        animation: text 0.5s cubic-bezier(0.075, 0.82, 0.165, 1) 2.5s 1 normal
          forwards;
      }
    }
  }
  #subText {
    ...
    &.small-show {
      animation: show 2s ease-in 0.3s 1 normal;
    }
  }
}
@keyframes float {

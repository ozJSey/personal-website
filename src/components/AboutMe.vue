                                ...
                                <div class="icons-not-fa">
                                    <svg height="40%" viewBox=".29 .22 77.26 95.75" width="40%"
                                        ...
                                        <g fill="none" fill-rule="evenodd">
                                            <path d="m48.75 95.97-25.91-25.74 14.32-14.57 40.39 40.31z"
                                                fill="#02539a" />
                                            <g fill="#45d1fd">
                                                <path d="m22.52 70.25 25.68-25.68h28.87l-39.95 39.95z"
                                                    fill-opacity=".85" />
...
@include mobile{
            ...
            &.active:nth-child(-n+4){
             ...
             &:nth-child(n)::after{
                ...
                height: 30px;
                background:radial-gradient(rgba(233, 213, 77, 0.9), rgba(255, 222, 0, 0.36));
            }
            &:nth-child(2n){
                border-bottom: 0px;
                border-right: 0px;
    ...
    @keyframes panel {
        from{
            box-shadow: 2px 2px 10px 10px rgba(255,255,255,.4), inset 2px 2px 10px 10px rgba(255,255,255,.4);
        }
        5%{
            box-shadow: -2px -2px 10px 10px rgba(255,255,255,.6) , inset -2px -2px 10px 10px rgba(255,255,255,.6);
        }
        10%{
            box-shadow: 0;
        }
